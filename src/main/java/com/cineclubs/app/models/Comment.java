...
public class Comment {
    ...
    public Comment(Long id, String content, LocalDateTime createdAt, User author,
            Post post, Comment parentComment, Set<Comment> replies, Set<User> likes) {
        this.id = id;
    ...
    public String toString() {
        return "Comment{" +
                ...
                ", content='" + content + '\'' +
                ", createdAt=" + createdAt +
                ", authorId=" + (author != null ? author.getClerkId() : null) +
